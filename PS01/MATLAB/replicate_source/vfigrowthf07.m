...
N=size(k); %this returns the dimensions; next line grabs the number we want
N=N(1,2);
...
n=1; %if want to run value function iteration for a set number of iterations
while pcntol >.0001;
...
save 387vdr vsr I k n;
save 387parm b a d N inc klb kub;

message=['Done! Converged in ',num2str(n),' iterations.']
disp(message)
